...
const Collaborators = () => {
    return (
        <div>
            <Modals />
            <div className="collaborator-nav">
                <div>
                    <h1>Colaboradores</h1>
                    <p className="collaborator-subtutitle-nav">Administra y añade nuevos colaboradores</p>
                </div>
                <div>
            ...
            <div className="input-wrapper">
                <input type="text" className="input" placeholder="Busca un colaborador..." />
